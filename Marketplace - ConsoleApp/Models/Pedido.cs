...
using Marketplace___ConsoleApp.Models.MétodosDePagamento;
...
namespace Marketplace___ConsoleApp.Models
{
    public class Pedido
    {
        ...
        public string GerarComprovanteTXT(Cliente c) 
        {
            ...
            try
            {
                File.WriteAllText(downloadPath + $"comprovante{Id}.txt", $"Comprovante de pagamento: {Environment.NewLine + c.ToString() + Environment.NewLine + ToString()}");
